...
# Everything above this line is generated by deploy_cell: https://github.com/path-robotics/deploy_cell/blob/a6b6f9c377a935abe194a6fae6c708dc260a9cea/roles/bootstrap_install/templates/bashrc.j2
...
alias flush-branches="git branch --merged develop | grep -vE '^[*+]|^[[:space:]]+develop$' | xargs --no-run-if-empty git branch -d && git remote prune origin"
alias la="ls -al"
alias ls="ls -GFh"
...
review-pr() {
  ...
  tmux send-keys -t "${panes[1]}" "claude  --permission-mode acceptEdits \"/review $url -- follow the review guidance in $prompt_file\" Report your findings as clearly and concisely as possible in a document at the root of this repository" C-m  # top-right
